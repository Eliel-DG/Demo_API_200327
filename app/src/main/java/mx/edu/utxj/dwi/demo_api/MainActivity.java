...
public class MainActivity extends AppCompatActivity {
    ...
    private String url = "http://192.168.1.72:3300/";
                ...
                if (etCodigoBaras.getText().toString().isEmpty()) {
                    ...
                    JsonObjectRequest actualizar = new JsonObjectRequest(
                            ...
                            new Response.ErrorListener() {
                                @Override
                                public void onErrorResponse(VolleyError error) {
                                    Toast.makeText(MainActivity.this, "Este producto no existe", Toast.LENGTH_SHORT).show();
                                }
                            }
                            ...
                            new Response.Listener<JSONObject>() {
                                ...
                                public void onResponse(JSONObject response) {
                                    try {
                                        ...
                                        } else if (response.getString("status").equals("Producto no eliminado")) {
                                            Toast.makeText(MainActivity.this, "Producto no eliminado", Toast.LENGTH_SHORT).show();
